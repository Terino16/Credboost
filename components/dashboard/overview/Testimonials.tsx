...
export default function Subscription({
  ...
  return (
    <div className="relative flex flex-col items-center justify-center p-4 w-full space-y-4 border-[0.5px] border-zinc-200 dark:border-zinc-900 rounded-lg overflow-hidden  group ">
      <div className="flex items-center justify-between w-full">
        <span className=" text-lg tracking-tighter font-[500]">Testimonials</span>
